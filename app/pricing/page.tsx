...
const Pricing = () => {
    ...
    return (
        <div className="w-full  md:items-center md:justify-center
            ...
            <Navbar
                scrollToWebsiteDesign={handleScrollToWebsiteDesign}
                scrollToGraphicDesign={handleScrollToGraphicDesign}
                scrollToShopifyStores={handleScrollToShopifyStores}
                //scrollToDesigns={handleScrollToDesigns}  // Remove this line
